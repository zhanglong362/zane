...
BASE_DB=os.path.join(BASE_PATH,'db','%s.json')
...
logfile=os.path.join(BASE_LOG_LOCAL,'BOSS')
...
LOGGING_DIC = {
    ...
    'loggers': {
        ...
        '': {
            'handlers': ['default', 'console','ATM'],  # 这里把上面定义的两个handler都加上，即log数据既写入文件又打印到屏幕
            'level': 'DEBUG',
